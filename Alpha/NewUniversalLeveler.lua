...
function LoadMenu()
	do
		Universal = MenuConfig("UniversalLeveler", "Universal Leveler")
		Universal:Menu("Settings", "Settings", "adjust-alt")
		Universal.Settings:Boolean("LevelUp", "Level Up Skills", true)
		Universal.Settings:Slider("StartLevel", "Level to enable lvlUP", 1, 1, 17)
		Universal.Settings:DropDown("autoLvl", "Skill order", 1, {"Soon"})
		Universal.Settings:Boolean("Humanizer", "Enable Level Up Humanizer", true)
		Universal.Settings:Info("Info", "Author: "..CopyRight)
		Universal.Settings:Menu("Delay", "Delay")
		Universal.Settings.Delay:Slider("Min", "Min level up delay (ms)", 255, 100, 399)
		Universal.Settings.Delay:Slider("Max", "Max level up delay (ms)", 665, 400, 2000)
	end
end
